package com.javely.ucrop.sample;
...
import com.javely.ucrop.UCropActivity;
import com.javely.ucrop.UCropFragment;
import com.javely.ucrop.UCropFragmentCallback;
...
public class SampleActivity extends BaseActivity implements UCropFragmentCallback {
    ...
    /**
     * Sometimes you want to adjust more options, it's done via {@link com.javely.ucrop.UCrop.Options} class.
     *
     * @param uCrop - ucrop builder instance
     * @return - ucrop builder instance
     */
